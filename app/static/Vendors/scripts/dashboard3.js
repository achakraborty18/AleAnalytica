...
// 	console.log("Here");
// 	response = await fetch("http://127.0.0.1:5000/display/generateDendogram");
// 	if (response.ok) {
// 		let dendogramJson = await response.json();
// 		console.log("dendogramJson");
...
// var chart = new ApexCharts(document.querySelector("#dendogram-chart"), options);
// chart.render();
